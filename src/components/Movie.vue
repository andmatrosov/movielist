  ...
  <div class="movie">
    ...
    <div>
      ...
      <div class="movie-buttons" v-if="!isSearch">
        <button class="btn movie-buttons-watched" @click="setWatched(movie.id)">
          <span v-if="!movie.isWatched">Watched</span>
          <span v-else>Unwatched</span>
        </button>
        <button class="btn movie-buttons-delete" @click="deleteMovie(movie.id)">Delete</button>
      </div>
      <div class="movie-buttons" v-else>
        <button class="btn btn_green" @click="addToUserMovies(movie)">Add</button>
      </div>
    </div>
  </div>
</template>
...
const addToUserMovies = (object) => {
  searchStore.addToUserMovies(object);
};
</script>
